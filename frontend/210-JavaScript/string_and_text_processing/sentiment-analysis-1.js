...
function sentiment(text) {
  var positive = text.replace(/\n/g, ' ').split(/[-:\.\!\,\? ]/).filter(word => positiveWords.includes(word));
  var negative = text.replace(/\n/g, ' ').split(/[-:\.\!\,\? ]/).filter(word => negativeWords.includes(word));
  ...
  if (positive.length > negative.length) {
    ...
    console.log('The sentiment is neutral.');
  }
}
